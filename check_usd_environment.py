...
def main():
    ...
    if results["usd_api"]:
        ...
        print()
        print("     使用輔助腳本 / Use helper script:")
        print("     python convert_via_explorer.py <input.usd>")
        print()
        print("     或手動步驟 / Or manual steps:")
        ...
        print("     - 使用 convert_via_explorer.py 生成 Kit 環境腳本")
        print("       Use convert_via_explorer.py to generate Kit environment script")
        print()
